...
gallery_zigbang_chart:
  ...
  - url: /assets/images/about/Zigbang/chart_type3.png
    image_path: /assets/images/about/Zigbang/chart_type3.png
  - url: /assets/images/about/Zigbang/chart_type4.png
    image_path: /assets/images/about/Zigbang/chart_type4.png
...
- Frontend
  - Cross platform : [React Native](#){: .btn .btn--small .btn--success} [Flutter](#){: .btn .btn--small .btn--success}
  - JS Library : [React.js](#){: .btn .btn--small .btn--info} [Vue.js](#){: .btn .btn--small .btn--success} [jQuery](#){: .btn .btn--small .btn--info}
  ...
  - Test
    ...
    - Test Infra : [Browserstack](#){: .btn .btn--small .btn--info}
...
- WebServer : [Nginx](#){: .btn .btn--small .btn--success} [Apache](#){: .btn .btn--small .btn--success}
...
- <h3> [국립암센터] 암발생 지리정보 서비스 <span class="big-tag">Slowalk</span></h3>
    ...
    - <U>기억에 남는 경험</U> :
      ...
      > 그래서 ***기존의 MongoDB ➡️ Oracle로, ODM([Mongoose](https://mongoosejs.com/)) ➡️ ORM([node-oracledb](https://github.com/oracle/node-oracledb)), 백엔드 코드를 다 마이그레이션함.***
...
- ### 단쿠키(단국대 커뮤니티)
  ...
  - 본인이 공헌한 점 : 풀스택으로 개발 참여. 교수 인기투표, 학교 주변맛집 지도시각화. 기능 고도화 및 버그&에러 수정, 동아리별 페이지 제작(예시 : [https://github.com/Seunghyum/dankookie-D-Voice](https://github.com/Seunghyum/dankookie-D-Voice))
  - 사용한 Skill 또는 지식 :
