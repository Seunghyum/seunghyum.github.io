...
- 프론트엔드 : [jQuery](#){: .btn .btn--small .btn--info}, [HTML&CSS](#){: .btn .btn--small .btn--info}, [SASS(SCSS)](#){: .btn .btn--small .btn--info}
- 프론트엔드 프레임워크 : [Vue.js](#){: .btn .btn--small .btn--info}, [React.js](#){: .btn .btn--small .btn--success}
- 데이터베이스 : [MySQL](#){: .btn .btn--small .btn--info}, [MongoDB](#){: .btn .btn--small .btn--info}
...
- etc : [Docker](#){: .btn .btn--small .btn--info}, [AWS(EC2, S3, RDB, VPC, Elastic Beanstalk)](#){: .btn .btn--small .btn--info}
- 익숙한 라이브러리 : [D3.js](#){: .btn .btn--small .btn--info}, [Naver Map API](#){: .btn .btn--small .btn--info}, [Puppeteer](#){: .btn .btn--small .btn--info}
...
- **[Slowalk](https://www.slowalk.co.kr/)** 개발자 근무 2016/06 ~ 2019/4 퇴사
  ...
  - ### <한국백혈병어린이재단> 희망별빛 캠페인 원페이지 제작
    - 담당업무 : 풀스택 개발. 간단한 원페이지의 소개 + 이메일 신청 기능
    - 백엔드 : Ruby on Rails
  ...
  - ### <언론재단> 뉴스트러스트 프로젝트 
    - 담당업무 : 기본적인 데이터 가공 + Read기능 위주의 홈페이지, 가공한 데이터 시각화, 설문조사 페이지 제작
    - 백엔드 : Ruby on Rails
    - 프론트엔드 : Jquery, HTML&CSS
    - DB : MongoDB
    - 웹서버 : Nginx
  ...
  - ### <국립암센터> 암발생 지리정보 서비스
    - 담당업무 : 풀스택 개발. 지도와 차트를 통한 데이터 시각화, 클라이언트의 IDC의 서버 세팅 규정에 따라 서버 세팅(RedHat)
    - 백엔드 : Node.js
    - 프론트엔드 : Vue.js
    - DB : Oracle
    - OS : Red hat(CentOS 7)
...
<center>
  ...
  - ### 단국대 국제학부 사물함 & 중고책 온라인 예약서비스
    - 운영했던 서비스
    - 진행기간 : 2017년
    - 주요내용 : 단국대 국제학부 사물함 & 중고책 온라인 예약서비스. 자리예약 기능. 국제학부 200여명 대상으로 실제 서비스 함.
    - 본인이 공헌한 점 : 풀스택 개발.
    - 사용한 Skill 또는 지식 : 
      - 지식 : MVC 모델, Queue
      - Skill : Ruby On Rails, HTML&CSS, jQuery, MySQL, AWS EC2/S3, GitHub
